            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.proposals.index') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('Back to proposals') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                @error('proposal_text')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="date" id="delivery_time" name="delivery_time" class="form-control" value="{{ old('delivery_time', isset($job) ? $job->delivery_time : '') }}">
